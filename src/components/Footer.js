    ...
    return (
        ...
        <div className="footer_container">
            ...
            <div className="copyright">
                ...
                <p>
                Hyer® HQ - Eindhoven, Pays-Bas <br />
                Enregistré à la Chambre de commerce <br />
                néerlandaise : 80195520
                </p>
            </div>
            </div>
            <div className="fd">
            ...
            <div className="fd_2">
                <div className="f4">
                <p className="fontW">Entreprise</p>
                ...
                <div className="f5">
                <p className="fontW">Mon compte</p>
            ...
            <div className="f9">
                <p>
                Hyer® est un courtier d'affrètement avec une plateforme numérique
                mondiale et n'est pas un transporteur aérien direct. Tous les vols
                annoncés auxquels Hyer® a accès sont détenus et exploités par un
                transporteur aérien tiers dûment agréé, conformément aux règles
                définies par l'Agence de la sécurité aérienne de l'Union
                européenne (ou toute autre autorité compétente en vertu du droit
                étranger). Hyer® n'a pas d'assurance responsabilité civile
                supplémentaire. Les passagers sont couverts par l'assurance de
