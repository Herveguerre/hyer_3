  ...
  return (
    <div className="about ">
      ...
      <div className="flex ">
        ...
        <div className="avis">
          <p>
            Lors de mes vols privés, mon Flight Manager Valérie était là pour
            m'aider à répondre à toutes mes questions ou préoccupations.
            <br />~ Jesper
          </p>
        </div>
        ...
        <div className="avis">
          <p>
            Nous avons eu un mariage exceptionnel à Capri.Hyer nous a aidés avec
