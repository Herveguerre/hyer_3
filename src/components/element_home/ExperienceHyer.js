    ...
    <div className="sec_5">
      ...
      <div className="sec_5_content">
        <div className="sec_5_l">
          <p>
            Chez Hyer®, nous sommes audacieux. L'avion n'est qu'un outil que
            nous utilisons pour vous amener là où vous voulez être. Nos clients
            bénéficient de beaucoup plus de valeur pour leur investissement,
            accédant à une personnalisation inégalée lorsqu'ils volent en privé.
          </p>
          <p>
            Nous offrons <span>des expériences personnalisées </span>avec nos
            charters <span>à la demande </span>et{" "}
            <span>une flexibilité personnalisée </span>avec notre{" "}
            <span>vol partagé </span> exclusif . Nous améliorons votre façon de
            voler.
          </p>
        </div>
        ...
        <div className="sec_5_r">
          <div className="sec_5_card">
            <div className="sec5svg">
              <svg
                ...
                fill="currentColor"
                viewBox="0 0 256 256"
                className="IconItem_icon__2BpcG"
              >
            ...
            <p className="sec_5_cardP1">Adhésion enrichissante</p>
            <p className="sec_5_cardP2">
              Notre adhésion allie les avantages d'une carte jet à la simplicité
              d'un programme de fidélité. Accédez à des services qui ne sont
              disponibles nulle part sans frais élevés.
            </p>
          </div>
          ...
          <div className="sec_5_card">
            ...
            <p className="sec_5_cardP1">Vols partagés exclusifs</p>
            <p className="sec_5_cardP2">
              Notre adhésion allie les avantages d'une carte jet à la simplicité
              d'un programme de fidélité. Accédez à des services qui ne sont
              disponibles nulle part sans frais élevés.
          ...
          <div className="sec_5_card">
            ...
            <p className="sec_5_cardP1">Vols neutres en CO2</p>
            <p className="sec_5_cardP2">
              Notre adhésion allie les avantages d'une carte jet à la simplicité
              d'un programme de fidélité. Accédez à des services qui ne sont
              disponibles nulle part sans frais élevés.
      ...
      <button className="btn_sec_5">Réserver un avion</button>
    </div>
  );
}
