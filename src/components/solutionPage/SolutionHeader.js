...
export default function SolutionHeader() {
  return (
    <div className="headerS">
      ...
      <div className="burgercontainerS">
      ...
      <div className="HeroContentS">
        <h2>Découvrez Hyer®</h2>
        <p className="HeroPS">Concentrez-vous sur la destination, sans vous soucier de la meilleure façon de vous y rendre. L'avion parfait n'est qu'un détail lors de la conception d'une expérience fluide.</p>
        <button className="HeroBtnS">I</button>
